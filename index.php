    ...
    <header class="header" id="home">
        <div class="container">
            <div class="infos">
                ...
                <h6 class="title"><?php echo $nama ?></h6>
    ...
    <section id="about" class="section mt-3">
        <div class="container mt-5">
            <div class="row text-center text-md-left">
                <div class="col-md-3">
                    <img src="assets/imgs/man.svg" alt="" class="img-thumbnail mb-4">
                </div>
                <div class="pl-md-4 col-md-9">
                    <h6 class="title"><?php echo $nama ?></h6>
                    <p class="subtitle"><?php echo $profesi ?></p>
